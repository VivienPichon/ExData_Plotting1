...
par(mfrow= c(2,2))
## First
plot(data$timestr, data$Global_active_power, type="l", ylab="Global Active Power (kilowatts)", xlab = "")
## Second
plot( data$timestr, data$Voltage, type = "l", xlab = "datetime", ylab="Voltage")
## Third
...
## Fourth
with(data, plot(timestr, Global_reactive_power, type="l", xlab = "datetime"))
